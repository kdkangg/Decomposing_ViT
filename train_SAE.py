...
writer = SummaryWriter(f'runs/{args.modelpath}/SAE_ratio{args.ratio}_epochs{args.epochs}_lr{args.lr}')
...
for epoch in tqdm(range(args.epochs)):
    ...
    if total_loss < best_loss:
        ...
        counter = 0
        # Save the best model
        torch.save(tied_sae.state_dict, f'SAE_models/{args.modelpath}/SAE_ratio{args.ratio}_epoch{args.epochs}_lr{args.lr}.pth')
    else:
        counter += 1
